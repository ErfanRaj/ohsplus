  ...
  head: () => ({
    ...
    links: [
      ...
      },
      {
        ...
        href: "https://fonts.gstatic.com/s/vazirmatn/v13/Dxx78j6PP2D_kU2muijPEe1n2vVbfJRklWgyOReZ72DF_QY.woff2",
      },
          ...
          "@graph": [
            {
              ...
              "@id": "/#organization",
              name: "OHS Plus",
              alternateName: "OHS Plus | مرجع تخصصی HSE",
              slogan: "Where OHS Professionals Connect",
              description:
                "مرجع منابع دیجیتال بهداشت حرفه‌ای، ایمنی و HSE برای کارشناسان و سازمان‌ها.",
              url: "/",
              email: "erfann.rag@gmail.com",
              logo: {
                "@type": "ImageObject",
                "@id": "/#logo",
                url: "/favicon-192.png",
                contentUrl: "/favicon-192.png",
                width: 192,
                height: 192,
                caption: "OHS Plus",
              },
            ...
            },
            {
              ...
              potentialAction: {
                ...
                target: {
                  "@type": "EntryPoint",
                  urlTemplate: "/products?q={search_term_string}",
                },
